...
st.markdown("<h1 style='text-align:center; color: white; bottom-margin:0px; top-margin:0px; font-size:50px;'>ByteBot 🤖</h1>",unsafe_allow_html=True)
st.markdown("<h3 style='text-align:center; color: white; bottom-margin:0px; top-margin:0px;'>Chat With Me 📕</h3>",unsafe_allow_html=True)
st.markdown("<h4 style='text-align:center; color: white; bottom-margin:0px; top-margin:0px;'>Upload Your PDF Below 📥</h4>",unsafe_allow_html=True)
